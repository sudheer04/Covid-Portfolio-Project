-- Imported two table into MySQL Workbench 
-- Coviddeaths table consists of Location, Date, Total Population, Total Cases, New Cases
-- , Total Deaths, New Deaths as columns for all the countries around the world
-- Vaccinations table consists of Location, Date, Total Vaccinations, New Vaccination as columns for all the countries around the world
